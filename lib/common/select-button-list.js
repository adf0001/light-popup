...
var selectButtonList = function (message, options) {
	...
	for (i = 0; i < imax; i++) {
		...
		elItem = insert_adjacent_return.append(elInput,
			"<button class='light-popup-list-item' style='margin-bottom:0.5em;" + (sep ? "margin-top:1em;" : "") + (v[2] || "") + "'></button>");
		sep = false;
	...
	//add last cancel
	elItem = insert_adjacent_return.append(elInput,
		"<button class='light-popup-list-item' style='margin-bottom:1px;margin-top:1em;'>Cancel</button>");
